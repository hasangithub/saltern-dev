...
@section('content_header_title', 'Create Voucher')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="owner_loan_id" id="owner_loan_id" class="form-control">
                                ...
                                <option value="{{ $ownerLoan->id }}" data-amount="{{ $ownerLoan->approved_amount }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="staff_loan_id" id="staff_loan_id" class="form-control">
                                ...
                                <option value="{{ $staffLoan->id }}" data-amount="{{ $staffLoan->approved_amount }}">
...
$(document).ready(function() {
    $("#owner_loan_id, #staff_loan_id").on("change", function() {
