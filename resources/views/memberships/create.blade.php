    ...
    <div class="card-body">
        <form method="POST" action="{{ route('memberships.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="membership_date" id="membership_date" required>
            </div>

            <div class="form-group">
                <label for="owner_signature">Owner Signature</label>
                <input type="file" class="form-control" name="owner_signature" id="owner_signature" accept="image/*"
                    required onchange="previewImage(event, 'ownerSignaturePreview')">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" name="representative_signature" id="representative_signature"
                    accept="image/*" required onchange="previewImage(event, 'representativeSignaturePreview')">
