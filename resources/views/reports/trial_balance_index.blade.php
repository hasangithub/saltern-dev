...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Loan Trial Balance</h3>
                </div>
                <form action="{{ route('reports.loan-trial-balance.detailed') }}" method="GET">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <label>From Date</label>
        ...
        <div class="col-md-12">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Employee Loan Trial Balance</h3>
                </div>
                <form action="{{ route('reports.staff-loan-trial-balance.detailed') }}" method="GET">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <label>From Date</label>
