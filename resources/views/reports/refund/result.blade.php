...
@section('content_header_subtitle', 'Refund Report')
@section('page-buttons')
<a href="{{ route('refund.report.print', request()->all()) }}" class="btn btn-primary" target="_blank">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Refund Report</h3>
